...
public class MyAdapter extends ArrayAdapter<SingleRow> {
    ...
    public MyAdapter(Context _context, int _resource, List<SingleRow> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(w.user_id.equals(user_id)){
            tv.setBackgroundResource(R.drawable.speech_bold_square_left_filled);
            params.weight = 1.0f;
            params.gravity = Gravity.RIGHT;
            tv.setLayoutParams(params);
            tv1.setLayoutParams(params);
        }else{
            tv.setBackgroundResource(R.drawable.speech_bold_square_right_filled);
            params.weight = 1.0f;
